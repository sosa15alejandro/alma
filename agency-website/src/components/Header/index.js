...
import logo from "../../assets/almaeventos.png";
  ...
  return (
    <Headers ref={ref}>
      ...
      <Nav>
        ...
        <a href="#quienessomos" onClick={(e) => scrollUp("quienessomos", e)}>
          ¿Quíenes Somos?
        </a>
        <a href="#background" onClick={(e) => scrollUp("background", e)}>
          Background
        </a>
      ...
      <MobileMenu clicked={+click}>
        ...
        <a href="#quienessomos" onClick={(e) => handleClick("quienessomos", e)}>
          ¿Quíenes Somos?
        </a>
        <a href="#background" onClick={(e) => handleClick("background", e)}>
          Background
        </a>
