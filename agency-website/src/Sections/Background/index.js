...
const BackgroundApp = () => {
  ...
  useEffect(() => {
    ...
    const t1 = gsap.timeline({
      scrollTrigger: {
        trigger: document.getElementById("background"),
  ...
  return (
    <BackgroundSection id="background">
      <Background ref={ref}>
        <Title className="title">Background</Title>
        <Line id="line" />
      ...
      <Content ref={addToRefs}>
        <TextBlock
          ...
          subText={
            <h5>
              ...
              Sabmiller (Isenbeck), Coty Argentina y BGH.
        ...
        />
        <OBJ>
          <img src={Ceci} alt="Ceci Object" width="400" height="400" />
        </OBJ>
      </Content>
    </BackgroundSection>
  );
